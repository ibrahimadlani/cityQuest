<nav class="navbar navbar-expand-lg navbar-light border-bottom">
    <div class="container">
        <a class="navbar-brand d-lg-none d-block" href="index.php" style="width:258px;"><img src="img/cityQuest.svg" alt="" height="50"></a>
        ...
        <div class="collapse navbar-collapse  justify-content-between text-center" id="navbarNav">
            <a class="navbar-brand d-none d-lg-block" href="index.php" style="width:258px;"><img src="img/cityQuest.svg" alt="" height="50"></a>
            <ul class="navbar-nav">
                <li class="nav-item">
