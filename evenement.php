...
<div class="container">
    <div class="row">
        <div class="my-3 p-4  border rounded " id="2">
            <div class="row" data-bs-toggle="collapse">
                <div class="col-12">
                    <h1 class="fw-bold text-center">Hellfest</h1>
                    <p class="mb-0  text-center"><span class="lead "> Le regroupement de metaleux obèses</span><br><small class="text-danger">24 Mars 2020 - 28 Mars 2020</small></p>
                ...
                <div class="col-12">
                    <div class="row mt-4">
                        ...
                        <div class="col-12">
                            ...
                            <hr>
                            <h5>Photos</h5>
                            <div class="your-class mb-3 border rounded p-2">
